...
| 0.20.0 | Identity | Per-faction unit and ship names, each a stat trade; two small bonuses per realm | ✅ shipped |
| 0.21.0 | Polish | 10 elite units, the owner's real art, balance pass | |
